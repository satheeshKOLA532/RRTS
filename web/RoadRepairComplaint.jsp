...
<body>
    ...
    <div class="container">
        ...
        <table>
            ...
            <%
                ...
                try {
                    ...
                    String sql = "SELECT * FROM superviser_complaint_report";
                    resultSet = statement.executeQuery(sql);

                    // Display complaint details in a table
                    while (resultSet.next()) {
                        String c_id = resultSet.getString("complaint_id");
                        String rm = resultSet.getString("raw_material");
                        String mr = resultSet.getString("machine_required");
                        String lc = resultSet.getString("labour_count");
        ...
        function backToHome() {
            ...
            window.location.href = "after_admin_login.jsp";
        }
        </script>
</body>
</html>
